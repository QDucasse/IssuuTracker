...
class AffinityFinder():
    ...
    def also_likes(self,doc_uuid,df=None,sort_func=None):
        ...
        if df is None:
            df = self.df
        df_list = [docs for visitor in self.readers_of(df,doc_uuid) for docs in self.has_read(df,visitor)]
        if sort_func is None:
            return df_list
        else:
...
if __name__ == "__main__":
    ...
    # Test 1
    print(af.readers_of('130228184234-6fd07690237d48aaa7be4e20cb767b13'))
    print(af.has_read('bd378ce6df7cb9cd'))
    print(af.also_likes('120928161916-bbf9b86bb865460a8e674d5338115a18'))

    # Test 2
    print(has_read('2f63e0cca690da91'))
    print(also_likes('140219141540-c900b41f845c67cc08b58911155c681c'))
